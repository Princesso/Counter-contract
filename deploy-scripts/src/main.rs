...
async fn main() -> Result<(), Error> {
    ...
    let init_method_name: &str = "init_counter_contract"; // Example
    ...
    use counter_contract::MyInputType; // Example
    ...
    let update_payload = transactions::UpdateContractPayload {
        ...
        receive_name: OwnedReceiveName::new_unchecked("counter_contract.receive".to_string()),
